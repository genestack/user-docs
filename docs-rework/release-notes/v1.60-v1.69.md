...
* Record key actions related to **users, groups, studies, metadata, access, ownership, and file downloads**.
...
* Track metadata changes with references to **previous and new metadata versions**, including restored versions.
