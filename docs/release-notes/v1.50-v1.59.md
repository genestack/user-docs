...
Reference Genome ID.
    ...
    ??? success "Affected endpoints"  
        ...
        * GET `/api/v1/as-curator/omics/variant/group`
        ...
        <figcaption>The parameter <strong>referenceGenomeId</strong> has been added to selected endpoints, to allow
         retrieval of variant data filtering for specific Reference Genome ID</figcaption>
...
available via a new API endpoint: POST `api/v1/reference-genomes`, part of the new definition `referenceGenome`.
    ...
    ??? danger "New Endpoints to retrieve and import Reference Genomes"
        ...
        * GET `/api/v1/reference-genomes/{id}`
        ...
        <figcaption>The definition <strong>referenceGenome</strong> has been created. This definition includes endpoints
        to retrieve and upload reference genomes</figcaption>
