...
* ??? danger "Affected endpoints (for both as-curator and as-users) that include the dedicated parameter variantInfo(with the same functionality)"
    * GET /api/v1/as-user/variants
    * GET /api/v1/as-curator/variantsa
...
* ??? abstract "Important considerations of the Reference Genome endpoints"
    ...
    * | Field Name    | Required | Description |
      ...
      | organism      | Yes | Scientific name with the first uppercase letter and underscore as a delimiter (e.g. Homo\_sapiens).  |
...
![filesMetadata.png](1.59/filesMetadata.png){width=700}
