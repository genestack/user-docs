...
The Processors Controller **[OpenAPI specification](/swagger/?urls.primaryName=processorsController)** and **[User Guide](../user-guide/doc-odm-user-guide/transformations/about-processors-controller.md)** have been updated to reflect the changes in this release.
...
![Template description](1.63/Template%20description.png)
...
![Reorder attributes](1.63/Reorder%20attributes.png)
...
![Metadata from TSV](1.63/Metadata%20from%20tsv.png)
<figcaption>Upload study metadata from Study tab in edit mode</figcaption>

![Metadata from TSV Data tab](1.63/Metadata%20from%20TSV%20Data%20tab.png)
...
![Drag and drop](1.63/Drag%20and%20drop.png)
...
* Fixed a SQL-injection vulnerability where a query parameter was being concatenated directly into a database query.
