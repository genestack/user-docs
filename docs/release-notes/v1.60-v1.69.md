...
* **Deletion**: Remove Cell metadata or expression groups via the **manage-data/data** endpoint.
    ...
    ![Data Model](../user-guide/doc-odm-user-guide/doc-odm-user-guide/images/data-model.png)
...
2. As a result, all users registered in ODM via Azure SSO will need to log in via the UI once to have their records updated in the database.
