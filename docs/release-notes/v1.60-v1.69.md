...
### Search by published metadata
   ...
   Previously, the Study Browser and API displayed both draft (staging) and committed metadata. This could result in
   ...
   **Key Updates:**
   ...
   3. **User and Curator API Endpoints:**
      - Both User and Curator APIs now return metadata exclusively from the latest committed **published** version,
