...
- [`../../how-to/single-cell/hdf5-transformations.md`](../../how-to/single-cell/hdf5-transformations.md) — step-by-step guidance for running the transformation
- [`../../reference/single-cell/transformation-config.md`](../../reference/single-cell/transformation-config.md) — full configuration schema reference
- [`../../tutorials/single-cell/sc-workflow.md`](../../tutorials/single-cell/sc-workflow.md) — end-to-end single-cell workflow tutorial
