...
> **Related documentation:** For conceptual background, see [About Single-Cell HDF5 Transformations in ODM](../../explanation/single-cell/hdf5-transformations.md). For configuration parameter definitions and default values, see the [Configuration Reference](transformation-config.md). For guides to running the transformation, see [Single-cell data in ODM: Getting Started](../../tutorials/single-cell/sc-workflow.md) and [How-to Guides](../../how-to/single-cell/hdf5-transformations.md).
...
Examples of valid configurations can be found in [Example configurations](example-configs.md).
