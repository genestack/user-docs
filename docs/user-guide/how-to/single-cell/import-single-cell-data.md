...
> For a full end-to-end tutorial including transformation and querying, see [Tutorial: End-to-end single-cell workflow](../../tutorials/single-cell/sc-workflow.md).

> For HDF5 transformation options, see [HDF5 transformation how-tos](hdf5-transformations.md).
...
Import study as [described here](../studies-import/import-samples-api.md).
...
Import samples as [described here](../studies-import/import-samples-api.md).
...
Import Cell metadata as [described here](../studies-import/import-samples-api.md).
...
```
Learn more about [uploading data to ODM via API here](../studies-import/import-omics-data-api.md).
...
Please use [manage-data/data endpoint](../../getting-started/admin.md) to delete Cell metadata or Cell expression group.
