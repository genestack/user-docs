...
> For background on what HDF5 transformations are and why they're needed, see [About HDF5 transformations](../../explanation/single-cell/hdf5-transformations.md).
...
To get started quickly with the full upload-to-query workflow, see the [Single-cell data in ODM: Getting Started](../../tutorials/single-cell/sc-workflow.md). For a conceptual overview of the entities involved and how the transformation works, see [About Single-Cell HDF5 Transformations in ODM](../../explanation/single-cell/hdf5-transformations.md). For the full list of configuration parameters, see the [Configuration Reference](../../reference/single-cell/transformation-config.md). For the API endpoint specifications, see the [API Reference](../../reference/api/processors-api.md). For details on what the pipeline does internally at each stage, see the [Transformation Process Reference](../../reference/single-cell/transformation-pipeline.md).
...
For a full description of the `data` object, see the [Configuration Reference](../../reference/single-cell/transformation-config.md).

For a list of ready-to-use configurations, see the [Example configurations](../../reference/single-cell/example-configs.md).
...
For the details, see [Attribute Mapping Reference](../../reference/single-cell/attribute-mapping.md)
...
For full parameter specifications, see the [Configuration reference](../../reference/single-cell/transformation-config.md).

## See also

- [Transformation configuration reference](../../reference/single-cell/transformation-config.md)
