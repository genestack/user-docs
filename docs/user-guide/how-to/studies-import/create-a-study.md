...
> This guide covers the GUI workflow. To create a study via API, see [Import samples (API)](import-samples-api.md) — study creation is the first step in that guide.
...
!!! tip "Understanding Templates"
    ...
    the [Templates and Validation](../../explanation/templates-and-validation.md) section. This section provides definitions and details about templates, including how to 
    create and edit them. Explore the [Template Editor](../metadata-templates/create-template.md) if you require more information or need detailed guidance.
...
![study-tabs.gif](../../doc-odm-user-guide/doc-odm-user-guide/gifs/study-tabs.gif)
...
![study-accession.gif](../../doc-odm-user-guide/doc-odm-user-guide/gifs/study-accession.gif)
...
![study-edit.gif](../../doc-odm-user-guide/doc-odm-user-guide/gifs/study-edit.gif)
