...
![image](../../doc-odm-user-guide/doc-odm-user-guide/images/versioning-view.png)

To change to Edit mode (curators only) click the **Edit** button in the bottom left of the Metadata Editor tab.

![image](../../doc-odm-user-guide/doc-odm-user-guide/images/versioning-edit-button.png)
...
![image](../../doc-odm-user-guide/doc-odm-user-guide/images/versioning-pending-tabs.png)
...
![image](../../doc-odm-user-guide/doc-odm-user-guide/images/versioning-dialogue.png)
...
![image](../../doc-odm-user-guide/doc-odm-user-guide/images/versioning-discard.png)
...
![image](../../doc-odm-user-guide/doc-odm-user-guide/images/versioning-history-icon.png)

This displays a list of versions and change descriptions.

![image](../../doc-odm-user-guide/doc-odm-user-guide/images/versioning-history.png)
...
![image](../../doc-odm-user-guide/doc-odm-user-guide/images/versioning-confirm.png)
...
!!! abstract "Import Blocked by Existing Links"
    ...
    ![image](../../doc-odm-user-guide/doc-odm-user-guide/images/disabled-import.png)
